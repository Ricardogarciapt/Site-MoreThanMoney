...
export function TapToTradePreview() {
  ...
  const handleAcceptSignal = (signal: Signal) => {
    ...
    // Na versão de demonstração, apenas atualizamos o estado
  }
        ...
        >
          ...
          <CardContent className="py-3">
            ...
            <div className="mt-3 flex items-center">
              <p className="text-xs text-gray-400 mr-2">Taxa de Acerto:</p>
              <p className="font-medium text-gold-500">{signal.winRate}%</p>
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent>
                    <p className="text-xs">Baseado nos últimos 50 sinais similares</p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
            </div>
