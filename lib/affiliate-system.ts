...
export const commissionTable: AffiliateCommission[] = [
  ...
  {
    productId: "mtm-gold-killer-lifetime",
    productName: "MTM Gold Killer V2.1 - Vitalício",
    rate: 25, // 25% de comissão
    basePrice: 750, // 750€
    minimumRoleRequired: "Distribuidor",
    excludedRoles: ["Membro", "Membro VIP"],
  },
  {
    productId: "mtm-scanner-annual",
    productName: "Scanner MTM V3.4 - Anual",
    rate: 30, // 30% de comissão
    basePrice: 150, // 150€
    minimumRoleRequired: "Distribuidor",
    excludedRoles: ["Membro", "Membro VIP"],
