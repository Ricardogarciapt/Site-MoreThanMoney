...
export default function AdminDashboardPage() {
  ...
  const adminModules = [
    ...
    },
    {
      ...
      description: "Gerencie catálogo, preços e stock",
      icon: ShoppingCart,
    ...
    {
      title: "Gerenciar Testemunhos",
      description: "Adicione, edite e gerencie testemunhos",
      icon: MessageSquare,
      href: "/admin-dashboard/testimonials-manager",
      color: "from-cyan-500 to-cyan-600",
      stats: "Testemunhos ativos",
    },
    {
      title: "Gerenciar Vídeos",
      description: "Configure vídeos do YouTube no site",
      icon: Video,
      href: "/admin-dashboard/videos-manager",
      color: "from-red-500 to-red-600",
      stats: "Vídeos configurados",
    },
    {
    ...
    {
      title: "Gestão do Telegram",
      description: "Configure bot e monitorize sinais",
      icon: Send,
    ...
    },
    {
      ...
      description: "Configure API e sincronização MT5",
      icon: Cpu,
    ...
    },
    {
      ...
      description: "Configure chaves e tokens do sistema",
      icon: Database,
    ...
    },
    {
      ...
      description: "Monitorize saúde e performance",
      icon: Zap,
      href: "/admin-dashboard/system-status",
      color: "from-yellow-500 to-yellow-600",
      stats: "Sistema online",
    },
  ]
