    ...
    <div className="min-h-screen bg-black">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Link href="/admin-dashboard/user-roles" passHref legacyBehavior>
            <div className="cursor-pointer">
              <Card className="bg-black/50 border-gold-500/30 backdrop-blur-sm h-full hover:border-gold-400 transition-colors">
                <CardHeader>
          ...
          <Link href="/admin-dashboard/site-settings" passHref legacyBehavior>
            <div className="cursor-pointer">
              <Card className="bg-black/50 border-gold-500/30 backdrop-blur-sm h-full hover:border-gold-400 transition-colors">
                <CardHeader>
                  <CardTitle className="flex items-center">
          ...
          <Link href="/admin-dashboard/statistics" passHref legacyBehavior>
            <div className="cursor-pointer">
              <Card className="bg-black/50 border-gold-500/30 backdrop-blur-sm h-full hover:border-gold-400 transition-colors">
                <CardHeader>
                  <CardTitle className="flex items-center">
